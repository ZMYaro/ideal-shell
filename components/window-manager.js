...
export class IdealWindowManager extends LitElement {
	...
	connectedCallback() {
		...
		this.openWindow('https://example.com', 'Example', '/images/app_icons/page.svg', '#808080');
		this.openWindow('https://paintz.app', 'PaintZ', '/images/app_icons/paintz.png', '#3f51b5');
	}
	 ...
	 * @param {String} defalutIconURL - The URL of the defalut icon for the app
	 * @param {String} color - CSS primary color for the app
	 */
	openWindow(url, defaultTitle, defaultIconURL, color) {
		let newWindow = document.createElement('ideal-window');
		newWindow.src = url;
		newWindow.defaultTitle = defaultTitle;
		newWindow.defaultIcon = defaultIconURL;
